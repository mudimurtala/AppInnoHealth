  ...
  return (
    <footer style={{ background: '#1a1a1a' }}>
      ...
      <div
        style={{
          background: '#242424',
          padding: isMobile ? '20px 16px' : '50px 20px',
        }}
      >
        <div
          style={{
        ...
        >
          ...
          <div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
              ...
              >
                <MapPin size={16} color="#00E5CC" style={{ flexShrink: 0, marginTop: '2px' }} />
                <span>3A Makarfi Road, Kaduna</span>
              </div>
              <div
                style={{
                  display: 'flex',
      ...
      >
        ...
        >
          ...
          >
            © {currentYear} InnoHealth Technologies. All rights reserved.
          </p>

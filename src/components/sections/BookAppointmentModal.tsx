      ...
      <div className="book-appointment-modal-overlay" onClick={onClose}>
        ...
        >
          ...
          {!submitted ? (
            ...
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', minHeight: 300, padding: 24 }}>
              <svg width="64" height="64" fill="none" viewBox="0 0 24 24"><circle cx="12" cy="12" r="12" fill="#00E5CC"/><path d="M7 13l3 3 7-7" stroke="#fff" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"/></svg>
              <h3 style={{ color: '#00E5CC', fontFamily: 'Comfortaa, cursive', fontWeight: 700, fontSize: 24, margin: '24px 0 8px' }}>Appointment Booked!</h3>
              <p style={{ color: '#fff', fontSize: 16, textAlign: 'center', marginBottom: 24 }}>Thank you for booking your appointment. We have received your request and will contact you soon.</p>
              <button onClick={onClose} style={{ background: '#1A2340', color: '#fff', border: 'none', borderRadius: 8, padding: '0.75rem 1.5rem', fontSize: 16, fontWeight: 600, cursor: 'pointer', fontFamily: 'Comfortaa, cursive' }}>
                Close
              </button>
            </div>
          )}
